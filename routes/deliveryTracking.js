...
router.get('/donation/:donationId', authenticate, authorize('admin', 'donor'), service.getByDonationId);
...
router.get('/:id/location', authenticate, authorize('admin', 'driver', 'donor'), service.getCurrentLocation);
